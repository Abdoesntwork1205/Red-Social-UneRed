...
Acceder a la aplicación a través del navegador ingresando la siguiente URL: http://localhost/social_network

Importar la base de datos unered.sql en phpMyAdmin y asegurarse de asignarle el mismo nombre unered.
